...
const galleryPages = {
  japan: {
    ...
    koreanDescriptionLines: [
      ...
      "",
      "3년 전 같은 시기에 방문했던 후추시의 ‘쿠라야미 마츠리’는 이번 여행의 가장 주된 목적이었다. 마지막 이틀간 이어진 화려한 축제 속에서 나는 물 만난 물고기처럼 신사 주변을 이리저리 누비며 인상적인 장면들을 포착해갔다. PRESS인 척하며 행사 메인 로드에 침입도 해보고, 배가 고파 들른 야끼소바 야타이에서는 반가운 얼굴을 우연히 마주하기도 했다.",
      "",
      "짧았지만 좋았다.",
    ],
    englishDescriptionLines: [
      ...
      "",
      "I still remember Nakano last August, when the heat was enough to turn black clothes white with salt. The summer event at Shikinomori Park, which seemed to shine through the midsummer heat, was no longer there, but I was curious to see what spring would look like instead. After such a long time away, I found myself traveling more cautiously than usual. Looking back, I don't think I made the most of my time in Nakano.",
      "",
...
thailand: {
  ...
  vietnam: {
    ...
    koreanDescriptionLines: [
      ...
      "",
      "따듯하고 활기찼지만 모두가 익숙한 이방인으로써 서로에 대한 미묘한 어색함이 맴돌던 곳이었다. 한국인이 많았기 때문이려나?",
      "일주일간의 방문으로 모든 것을 다 알긴 어렵겠지만 가족들은 “푸꾸옥 갈바엔 00가겠다” 라는 문장을 시작으로 다시 방문 할 일은 없을 거라고 코멘트를 남겼었다.",
      "",
      "나는 이상하게 이곳에서의 삶에 대한 궁금증 생겼다. 개발중인 도시에서의 삶은 어떨까?"
    ],
    englishDescriptionLines: [
      "I visited Phu Quoc with my wife's family on a trip celebrating my mother-in-law's 60th birthday.",
      "",
      "The island was filled with tourist attractions inspired by a mix of Asian and European cultures. Although geographically part of Vietnam it often felt as if several countries had come together to create a destination and then handed it back to Vietnam.That impression lingered throughout the trip.",
      "Much of the island was still under development, and the phrase that kept coming to mind was “An Incomplete Paradise.",
      "",
      ...
      "",
      "For some reason, I was left with a different feeling. I found myself wondering what life might be like here. What does it mean to live in a city that is still being built?"
    ]
  },
  france: {
  ...
  "25년 8월 30일. 결혼을 했다.",
  "",
  "나는 나라와 파리로 신혼여행을 떠났다. 이 사진들은 파리에서 보고 느낀 것들을 담아온 것이다.",
  "",
